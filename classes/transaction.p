...
@howTo[]
<div id="howto2" ^rem{style="display:none"}>
<span id="hider"></span>
...
<ul class="tabs">
	...
	<li><a href="#tab1">Сумма, количество, цена</a></li>
	<li><a href="#tab2">Чеки и скидки</a></li>
	<li><a href="#tab3">Указание даты</a></li>
	<li><a href="#tab4">Вычитание записей</a></li>
# 	<li><h5>Чеки и скидки</h5>
# 	<div>Магазин 2500:
# Товар 2000
# Товар 1000
...
# ^@Магазин
# Товар 2000
# Можно указать сумму чека, тогда для позиций чека рассчитается скидка, если их сумма больше суммы чека
...
# 	<li><h5>Указание даты</h5></li>
# 	<li><h5>Чеки и скидки</h5></li>
# 	<li><h5>Вычитание записей</h5></li>
# 	<li><h5>Явное указание типа записи</h5></li>
</ul>
# </div>
...
<div id="tab3">Молоко 100
Молоко 50*33
Молоко 3 по 50
Молоко 200\4
Молоко 4 за 200
</div>
<div id="tab4">Молоко 100
Молоко 50*34
Молоко 3 по 50
Молоко 200\4
Молоко 4 за 200
